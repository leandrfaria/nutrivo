        ...
        <div className="w-1/2 flex items-center justify-center p-8">
          <div className="flex flex-col items-center w-full max-w-xs gap-6">
            ...
            <div className="flex border border-[#e0c6a8] rounded-full overflow-hidden">
              <button className="px-6 py-2 bg-[#f3e4cc] text-forest font-semibold">
                Sign In
              </button>
              <button className="px-6 py-2 text-forest font-semibold">
                Sign Up
              </button>
            </div>
            ...
            <form className="flex flex-col gap-4 w-full">
              ...
              <button
                type="submit"
                className="bg-forest text-white font-semibold py-3 rounded-lg hover:bg-[#163328] transition"
              >
                Login
              </button>
